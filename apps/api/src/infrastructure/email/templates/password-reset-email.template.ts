...
export function buildPasswordResetEmailTemplate(
  props: PasswordResetEmailTemplateProps,
): {
  subject: string;
  html: string;
  text: string;
} {
  const { recipientName, resetUrl, expiryHours = 1 } = props;
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                    ...
                    <span style="font-size: 12px; color: #94a3b8; margin-left: 8px; font-family: 'JetBrains Mono', Courier, monospace;">SECURITY</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 36px 36px 24px 36px;">
              ...
              <p style="margin: 0 0 28px 0; font-size: 15px; color: #cbd5e1; line-height: 1.6;">
                We received a request to reset your Nebula account password. Click the button below to choose a new password.
              </p>
              ...
              <table border="0" cellspacing="0" cellpadding="0" style="margin: 0 0 32px 0;">
                <tr>
                  <td align="center" style="border-radius: 8px; background-color: #f8fafc;">
                    <a href="${resetUrl}" target="_blank" style="display: inline-block; padding: 13px 28px; font-size: 14px; font-weight: 600; color: #090d16; text-decoration: none; border-radius: 8px; letter-spacing: -0.01em;">
                      Reset Password &rarr;
                    </a>
                  </td>
                </tr>
              ...
              <p style="margin: 0 0 16px 0; font-size: 13px; color: #64748b; line-height: 1.5;">
                This password reset link will expire in ${expiryHours} hour. If you did not request a password reset, your account remains secure and no action is needed.
              </p>
...
We received a request to reset your Nebula account password. Use the link below to choose a new password:
