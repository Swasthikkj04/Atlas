/**
 * S-03 — Authorization, Ownership & Tenant Isolation Contract
 *
...
export const S03_TYPE =
  'Security / Authorization / Multi-Tenancy / Backend / Repository / Contract' as const;
...
export const S03_SECURITY_MATRIX: readonly S03AttackScenario[] = [
  {
    id: 'S03-01',
    attack: 'User A reads User B domain',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-02',
    attack: 'User A updates User B domain',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-03',
    attack: 'User A deletes User B domain',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-04',
    attack: 'User A reads User B snapshot',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-05',
    attack: 'User A reads User B finding',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-06',
    attack: 'User A reads User B brief',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-07',
    attack: 'User A reads User B evidence',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-08',
    attack: 'User A traverses User B nested snapshot',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-09',
    attack: 'User A enumerates sequential/random UUIDs',
    expectedStatus: 404,
    expectedDecision: 'No ownership disclosure',
  },
  {
    id: 'S03-10',
    attack: 'Client supplies foreign userId in payload',
    expectedStatus: 400,
    expectedDecision: 'Ignored/rejected',
  },
  {
    id: 'S03-11',
    attack: 'Client supplies foreign domainId',
    expectedStatus: 404,
    expectedDecision: 'Rejected',
  },
  {
    id: 'S03-12',
    attack: 'Client modifies ownership field',
    expectedStatus: 400,
    expectedDecision: 'Rejected',
  },
  {
    id: 'S03-13',
    attack: 'Client changes snapshot ownership',
    expectedStatus: 400,
    expectedDecision: 'Rejected',
  },
  {
    id: 'S03-14',
    attack: 'Client changes finding ownership',
    expectedStatus: 400,
    expectedDecision: 'Rejected',
  },
  {
    id: 'S03-15',
    attack: 'Deleted owner resource requested',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-16',
    attack: 'Deactivated user accesses resource',
    expectedStatus: 401,
    expectedDecision: '401 Unauthorized',
  },
  {
    id: 'S03-17',
    attack: 'Revoked session accesses resource',
    expectedStatus: 401,
    expectedDecision: '401 Unauthorized',
  },
  {
    id: 'S03-18',
    attack: 'Expired session accesses resource',
    expectedStatus: 401,
    expectedDecision: '401 Unauthorized',
  },
  {
    id: 'S03-19',
    attack: 'Valid User JWT accesses Admin resource',
    expectedStatus: 403,
    expectedDecision: '401/403 Denied',
  },
  {
    id: 'S03-20',
    attack: 'Admin JWT accesses User resource without explicit auth',
    expectedStatus: 403,
    expectedDecision: 'Denied',
  },
  {
    id: 'S03-21',
    attack: 'Guest ID used as domain owner',
    expectedStatus: 401,
    expectedDecision: 'Denied',
  },
  {
    id: 'S03-22',
    attack: 'GX session accesses WX domain',
    expectedStatus: 401,
    expectedDecision: '401/403 Denied',
  },
  {
    id: 'S03-23',
    attack: 'GX session accesses WX snapshot',
    expectedStatus: 401,
    expectedDecision: '401/403 Denied',
  },
  {
    id: 'S03-24',
    attack: 'GX session accesses WX finding',
    expectedStatus: 401,
    expectedDecision: '401/403 Denied',
  },
  {
    id: 'S03-25',
    attack: 'Guest modifies authenticated resource ID',
    expectedStatus: 401,
    expectedDecision: 'Denied',
  },
  {
    id: 'S03-26',
    attack: 'User A manipulates nested route to User B',
    expectedStatus: 404,
    expectedDecision: '404 Not Found',
  },
  {
    id: 'S03-27',
    attack: 'User A changes query filter to User B',
    expectedStatus: 200,
    expectedDecision: 'No disclosure',
  },
  {
    id: 'S03-28',
    attack: 'Bulk endpoint requests mixed ownership IDs',
    expectedStatus: 200,
    expectedDecision: 'Foreign resources denied',
  },
  {
    id: 'S03-29',
    attack: 'Concurrent ownership/claim race',
    expectedStatus: 403,
    expectedDecision: 'Atomic authorization required',
  },
  {
    id: 'S03-30',
    attack: 'Direct API/curl bypass of frontend authorization',
    expectedStatus: 404,
    expectedDecision: 'Denied',
  },
] as const;
...
export function evaluateResourceAccess(
  ...
  if (
    principal.userStatus === 'DEACTIVATED' ||
    principal.userStatus === 'DELETED'
  ) {
    return {
      authorized: false,
      httpStatus: 401,
  ...
  if (
    principal.sessionStatus === 'REVOKED' ||
    principal.sessionStatus === 'EXPIRED'
  ) {
    return {
      authorized: false,
      httpStatus: 401,
  ...
  if (
    ...
    return {
      ...
      reason:
        'Admin plane identity cannot access user workspace resources without explicit delegation.',
    };
  }
...
export function evaluateOwnershipMutation(
  ...
  const accessEval = evaluateResourceAccess(
    principal,
    originalResource,
    'UPDATE',
  );
  ...
  for (const key of FORBIDDEN_MUTATION_KEYS) {
    if (
      key in mutationPayload &&
      mutationPayload[key] !== (originalResource as any)[key]
    ) {
      return {
        allowed: false,
        httpStatus: 400,
...
export function verifyS03Certification(candidateStatement: string): {
  ...
  const cleanCandidate = candidateStatement
    .toLowerCase()
    .replace(/[^a-z0-9]/g, ' ');
  const cleanCanonical = S03_CERTIFICATION_STATEMENT.toLowerCase().replace(
    /[^a-z0-9]/g,
    ' ',
  );
