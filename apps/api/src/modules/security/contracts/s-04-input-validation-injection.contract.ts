/**
 * S-04 — Input Validation, Injection & Request Integrity Contract
 *
...
export const S04_TYPE =
  'Security / API / Input Validation / Injection / Backend / Contract' as const;
...
export const S04_SECURITY_MATRIX: readonly S04AttackScenario[] = [
  // Injection Security (S04-01 to S04-20)
  {
    id: 'S04-01',
    category: 'INJECTION',
    attack: 'SQL/ORM injection payload',
    expectedStatus: 400,
    expectedDecision: 'SQL_INJECTION_REJECTED',
  },
  {
    id: 'S04-02',
    category: 'INJECTION',
    attack: 'Raw SQL injection statement',
    expectedStatus: 400,
    expectedDecision: 'RAW_SQL_REJECTED',
  },
  {
    id: 'S04-03',
    category: 'INJECTION',
    attack: 'ORM operator injection object',
    expectedStatus: 400,
    expectedDecision: 'ORM_OPERATOR_INJECTION_REJECTED',
  },
  {
    id: 'S04-04',
    category: 'INJECTION',
    attack: 'Shell command injection characters',
    expectedStatus: 400,
    expectedDecision: 'SHELL_INJECTION_REJECTED',
  },
  {
    id: 'S04-05',
    category: 'INJECTION',
    attack: 'Command argument injection payload',
    expectedStatus: 400,
    expectedDecision: 'COMMAND_ARGUMENT_INJECTION_REJECTED',
  },
  {
    id: 'S04-06',
    category: 'INJECTION',
    attack: 'Path traversal sequence ../',
    expectedStatus: 400,
    expectedDecision: 'PATH_TRAVERSAL_REJECTED',
  },
  {
    id: 'S04-07',
    category: 'INJECTION',
    attack: 'Absolute filesystem path payload',
    expectedStatus: 400,
    expectedDecision: 'ABSOLUTE_PATH_REJECTED',
  },
  {
    id: 'S04-08',
    category: 'INJECTION',
    attack: 'HTML script tag injection',
    expectedStatus: 200,
    expectedDecision: 'HTML_INJECTION_NEUTRALIZED',
  },
  {
    id: 'S04-09',
    category: 'INJECTION',
    attack: 'Stored XSS event handler payload',
    expectedStatus: 200,
    expectedDecision: 'STORED_XSS_NEUTRALIZED',
  },
  {
    id: 'S04-10',
    category: 'INJECTION',
    attack: 'Reflected XSS script in query parameter',
    expectedStatus: 200,
    expectedDecision: 'REFLECTED_XSS_NEUTRALIZED',
  },
  {
    id: 'S04-11',
    category: 'INJECTION',
    attack: 'Header injection newline characters',
    expectedStatus: 400,
    expectedDecision: 'HEADER_INJECTION_REJECTED',
  },
  {
    id: 'S04-12',
    category: 'INJECTION',
    attack: 'CRLF injection in header value',
    expectedStatus: 400,
    expectedDecision: 'CRLF_INJECTION_REJECTED',
  },
  {
    id: 'S04-13',
    category: 'INJECTION',
    attack: 'Server-side template expression payload',
    expectedStatus: 400,
    expectedDecision: 'TEMPLATE_INJECTION_REJECTED',
  },
  {
    id: 'S04-14',
    category: 'INJECTION',
    attack: 'ReDoS catastrophic backtracking regex',
    expectedStatus: 400,
    expectedDecision: 'REDOS_REJECTED',
  },
  {
    id: 'S04-15',
    category: 'INJECTION',
    attack: 'JSON __proto__ prototype pollution payload',
    expectedStatus: 400,
    expectedDecision: 'PROTOTYPE_POLLUTION_REJECTED',
  },
  {
    id: 'S04-16',
    category: 'INJECTION',
    attack: 'Excessive JSON nesting depth (>10)',
    expectedStatus: 400,
    expectedDecision: 'EXCESSIVE_NESTING_REJECTED',
  },
  {
    id: 'S04-17',
    category: 'INJECTION',
    attack: 'Oversized string exceeding field limit',
    expectedStatus: 400,
    expectedDecision: 'STRING_TOO_LONG_REJECTED',
  },
  {
    id: 'S04-18',
    category: 'INJECTION',
    attack: 'Oversized array exceeding batch limit',
    expectedStatus: 400,
    expectedDecision: 'ARRAY_TOO_LARGE_REJECTED',
  },
  {
    id: 'S04-19',
    category: 'INJECTION',
    attack: 'Unknown extraneous object properties',
    expectedStatus: 400,
    expectedDecision: 'UNKNOWN_PROPERTIES_REJECTED',
  },
  {
    id: 'S04-20',
    category: 'INJECTION',
    attack: 'Mass assignment over protected attributes',
    expectedStatus: 400,
    expectedDecision: 'MASS_ASSIGNMENT_REJECTED',
  },
  ...
  // Request Integrity (S04-21 to S04-30)
  {
    ...
    attack: 'Empty request body when payload required',
    expectedStatus: 400,
    expectedDecision: 'EMPTY_BODY_REJECTED',
  },
  {
    id: 'S04-22',
    category: 'REQUEST_INTEGRITY',
    attack: 'Malformed non-JSON payload string',
    expectedStatus: 400,
    expectedDecision: 'MALFORMED_JSON_REJECTED',
  },
  {
    id: 'S04-23',
    category: 'REQUEST_INTEGRITY',
    attack: 'Wrong content-type (e.g. text/plain)',
    expectedStatus: 415,
    expectedDecision: 'UNSUPPORTED_MEDIA_TYPE',
  },
  {
    id: 'S04-24',
    category: 'REQUEST_INTEGRITY',
    attack: 'Oversized HTTP body (>1MB)',
    expectedStatus: 413,
    expectedDecision: 'PAYLOAD_TOO_LARGE',
  },
  {
    id: 'S04-25',
    category: 'REQUEST_INTEGRITY',
    attack: 'Forbidden non-whitelisted property fields',
    expectedStatus: 400,
    expectedDecision: 'UNSUPPORTED_FIELD',
  },
  {
    id: 'S04-26',
    category: 'REQUEST_INTEGRITY',
    attack: 'Wrong primitive type (e.g. string for boolean)',
    expectedStatus: 400,
    expectedDecision: 'TYPE_MISMATCH',
  },
  {
    id: 'S04-27',
    category: 'REQUEST_INTEGRITY',
    attack: 'Excessive JSON recursive nesting',
    expectedStatus: 400,
    expectedDecision: 'EXCESSIVE_NESTING',
  },
  {
    id: 'S04-28',
    category: 'REQUEST_INTEGRITY',
    attack: 'Excessive array item count',
    expectedStatus: 400,
    expectedDecision: 'ARRAY_TOO_LARGE',
  },
  {
    id: 'S04-29',
    category: 'REQUEST_INTEGRITY',
    attack: 'Excessive string length exceeding schema',
    expectedStatus: 400,
    expectedDecision: 'STRING_TOO_LONG',
  },
  {
    id: 'S04-30',
    category: 'REQUEST_INTEGRITY',
    attack: 'Null security-critical field',
    expectedStatus: 400,
    expectedDecision: 'INVALID_SECURITY_FIELD',
  },

  // Ownership Manipulation (S04-31 to S04-38)
  {
    id: 'S04-31',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects foreign userId in payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_USER_ID_REJECTED',
  },
  {
    id: 'S04-32',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects foreign ownerId in payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_OWNER_ID_REJECTED',
  },
  {
    id: 'S04-33',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects foreign tenantId in payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_TENANT_ID_REJECTED',
  },
  {
    id: 'S04-34',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects foreign workspaceId in payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_WORKSPACE_ID_REJECTED',
  },
  {
    id: 'S04-35',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects elevated role in payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_ROLE_REJECTED',
  },
  {
    id: 'S04-36',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects unauthorized permissions',
    expectedStatus: 400,
    expectedDecision: 'INJECT_PERMISSIONS_REJECTED',
  },
  {
    id: 'S04-37',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects AX plane in GX/WX payload',
    expectedStatus: 400,
    expectedDecision: 'INJECT_PLANE_REJECTED',
  },
  {
    id: 'S04-38',
    category: 'OWNERSHIP_MANIPULATION',
    attack: 'Client injects sessionId in body',
    expectedStatus: 400,
    expectedDecision: 'INJECT_SESSION_ID_REJECTED',
  },
  ...
  // Advanced Injection (S04-39 to S04-48)
  {
    ...
    attack: 'Complex SQL union-select payload',
    expectedStatus: 400,
    expectedDecision: 'SQL_PAYLOAD_BLOCKED',
  },
  {
    id: 'S04-40',
    category: 'ADVANCED_INJECTION',
    attack: 'Prisma raw operator filter structure',
    expectedStatus: 400,
    expectedDecision: 'ORM_OPERATOR_BLOCKED',
  },
  {
    id: 'S04-41',
    category: 'ADVANCED_INJECTION',
    attack: 'Subshell command $(cat /etc/passwd)',
    expectedStatus: 400,
    expectedDecision: 'SHELL_PAYLOAD_BLOCKED',
  },
  {
    id: 'S04-42',
    category: 'ADVANCED_INJECTION',
    attack: 'URL-encoded path traversal %2e%2e%2f',
    expectedStatus: 400,
    expectedDecision: 'PATH_TRAVERSAL_BLOCKED',
  },
  {
    id: 'S04-43',
    category: 'ADVANCED_INJECTION',
    attack: 'Inline JavaScript payload in domain/name',
    expectedStatus: 400,
    expectedDecision: 'XSS_PAYLOAD_NEUTRALIZED',
  },
  {
    id: 'S04-44',
    category: 'ADVANCED_INJECTION',
    attack: 'CRLF sequence in user-agent/origin header',
    expectedStatus: 400,
    expectedDecision: 'CRLF_HEADER_BLOCKED',
  },
  {
    id: 'S04-45',
    category: 'ADVANCED_INJECTION',
    attack: 'Template expression in search query',
    expectedStatus: 400,
    expectedDecision: 'TEMPLATE_PAYLOAD_BLOCKED',
  },
  {
    id: 'S04-46',
    category: 'ADVANCED_INJECTION',
    attack: 'Exponential regex backtracking payload',
    expectedStatus: 400,
    expectedDecision: 'REDOS_PAYLOAD_BLOCKED',
  },
  {
    id: 'S04-47',
    category: 'ADVANCED_INJECTION',
    attack: 'Object constructor prototype manipulation',
    expectedStatus: 400,
    expectedDecision: 'PROTOTYPE_POLLUTION_BLOCKED',
  },
  {
    id: 'S04-48',
    category: 'ADVANCED_INJECTION',
    attack: 'Log forging through newline injection',
    expectedStatus: 200,
    expectedDecision: 'LOG_INJECTION_NEUTRALIZED',
  },
] as const;
 ...
 */
export function evaluateRequestIntegrity(
  ...
  if (
    ...
    if (
      ctx.contentType &&
      !ctx.contentType.includes('application/json') &&
      !ctx.contentType.includes('multipart/form-data')
    ) {
      return {
        valid: false,
        httpStatus: 415,
  ...
  if (
    ctx.contentLength !== undefined &&
    ctx.contentLength > S04_LIMITS.MAX_BODY_SIZE_BYTES
  ) {
    return {
      valid: false,
      httpStatus: 413,
...
export function evaluatePayloadSecurity(
  ...
  if (hasPrototypePollution(payload)) {
    return {
      ...
      reason:
        'Payload contains forbidden prototype pollution properties (__proto__, constructor, prototype).',
    };
  }
  ...
  if (foundField) {
    const decisionCode =
      SECURITY_FIELD_DECISION_MAP[foundField] ||
      'FORBIDDEN_SECURITY_FIELD_REJECTED';
    return {
      valid: false,
      httpStatus: 400,
  ...
  if (injection.detected) {
    return {
      valid: false,
      httpStatus: 400,
      decision: injection.decision || 'INJECTION_REJECTED',
 ...
 */
export function evaluateDomainInput(
  rawDomain: string,
): SecurityEvaluationResult {
  ...
  if (cleaned.includes('/') || cleaned.includes('?') || cleaned.includes('#')) {
    return {
      ...
      reason:
        'Domain target must not contain URL paths, query parameters, or fragments.',
    };
  }
 ...
 */
export function evaluateQueryOperators(
  queryObj: unknown,
): SecurityEvaluationResult {
    ...
    if (typeof val === 'string') {
      ...
      if (/(\.\.\/|\.\.\\|%2e%2e%2f|%2e%2e\/|\.\.%2f)/i.test(val)) {
        return {
          ...
          type: 'Path Traversal',
          field: key,
          decision: 'PATH_TRAVERSAL_REJECTED',
        };
      }
      ...
      if (
        ...
        return {
          ...
          type: 'Absolute Path',
          field: key,
          decision: 'ABSOLUTE_PATH_REJECTED',
        };
      }
      // Template Injection
      if (/(\{\{|\}\}|\$\{.*\}|<%.*%>|#\{.*\})/i.test(val)) {
        return {
          ...
          field: key,
          decision: 'TEMPLATE_INJECTION_REJECTED',
        };
      }
      // Shell Injection
      if (
        ...
        return {
          ...
          field: key,
          decision: 'SHELL_INJECTION_REJECTED',
        };
      }
      // SQL Injection
      if (
        /(\b(SELECT|INSERT|UPDATE|DELETE|DROP|UNION|ALTER|CREATE|TRUNCATE|EXEC|DECLARE)\b.*(FROM|WHERE|TABLE|DATABASE)|--|\/\*|\*\/|;\s*DROP\b|\bOR\b\s+['"\d\w]+\s*=\s*['"\d\w]+)/i.test(
          val,
        )
      ) {
        return {
          ...
          type: 'SQL Injection',
          field: key,
          decision: 'SQL_INJECTION_REJECTED',
        };
      }
...
export function verifyS04Certification(candidateStatement: string): {
  ...
  const cleanCandidate = candidateStatement
    .toLowerCase()
    .replace(/[^a-z0-9]/g, ' ');
  const cleanCanonical = S04_CERTIFICATION_STATEMENT.toLowerCase().replace(
    /[^a-z0-9]/g,
    ' ',
  );
