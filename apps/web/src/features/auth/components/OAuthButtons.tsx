    ...
    <div className="flex flex-col gap-3 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
        <button
          ...
          disabled={disabled}
          className="flex items-center justify-center gap-2 border border-border rounded-lg px-4 py-2.5 bg-card/60 hover:bg-muted/40 transition-colors text-xs font-medium text-foreground focus-visible:ring-2 focus-visible:ring-ring cursor-pointer disabled:opacity-50"
        >
